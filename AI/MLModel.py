...
# Load dataset
file_path = '/Users/kazangue/CS-Files/HackUTD/AI/plant_growth_data.csv'  # Adjust the path to your dataset
...
# Define search ranges for ideal conditions
...
# Getter functions for other files
